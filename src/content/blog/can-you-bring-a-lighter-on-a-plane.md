...
**Quick answer:** Yes — you can bring **one standard lighter** (disposable BIC-type or a Zippo) in your carry-on or pocket, and **flashlights are allowed in both carry-on and checked bags**. The big exceptions: **torch/jet-flame lighters are banned entirely**, lighters generally can't go in checked luggage, lighter fuel of any kind is prohibited on the plane, and **spare lithium batteries must travel in the cabin**, never in checked bags.

Here's the full breakdown so nothing of yours ends up in the airport bin.

## Lighters: The Rules at a Glance

| Item | Carry-on / on person | Checked bag |
|---|---|---|
| Disposable lighter (BIC-type) | ✅ Yes (one) | ❌ No* |
| Zippo / fluid lighter | ✅ Yes (one) | ❌ No* |
| Arc / plasma / electronic lighter | ✅ Yes (protected from turning on) | ❌ No |
...
A **completely empty, fuel-free** Zippo (no fluid, dry wick and cotton) is generally treated as an ordinary metal item and can go in checked luggage. In practice, "empty" is judged by the screener's nose — if it smells of fuel, expect it to be pulled. When in doubt, carry it on.
...
**Do power banks count as spare batteries?** Yes — carry-on only, under 100Wh, terminals protected. That includes the power bank feature on some larger camping torches.

**Can I take my headlamp?** Yes, same rules as flashlights: the device can fly anywhere, spare cells go in the cabin.

**What happens if TSA finds a banned item?** You'll be offered the usual options: return it to your car, hand it to a non-flying companion, mail it (at some airports), or surrender it. Torch lighters and fuel cans are surrendered at the checkpoint every day — cheaper to leave them home.
